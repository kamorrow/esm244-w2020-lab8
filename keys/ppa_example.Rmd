...
Compared with a simulation of complete spatial randomness, how many observations have a nearest neighbor closer or further away than the simulated expected value.
```{r}
